...
flow:
  ...
  inputs:
    - host: 10.0.46.10
    - username: "Capa1\\1280-capa1user"
    - password: Automation123
    - datacenter: Capa1 Datacenter
    - image: Ubuntu
    - folder: Students/JPM3
    - prefix_list: '1-,2-,3-'
  workflow:
    - uuid:
        do:
  ...
  graph:
    steps:
      ...
      wait_for_vm_info:
        ...
        y: 150
        navigate:
          3f98db80-da77-4487-3d83-7e6266347a58:
            targetId: c8be7912-a15a-3251-f137-c4e47bbbdbb6
            port: SUCCESS
    results:
      SUCCESS:
        c8be7912-a15a-3251-f137-c4e47bbbdbb6:
          x: 1600
          y: 150
